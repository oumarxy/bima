...
$config['tables']['users_groups']    = 'user_roles';
 ...
 */
$config['site_title']                 = "Thorn Insurance Broker Management System ";       // Site Title, example.com
$config['admin_email']                = "info@thornlimited.com"; // Admin Email, admin@example.com
$config['default_group']              = 'Claim Officer';           // Default group, use name
