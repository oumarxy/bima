...
class Ion_auth_model extends CI_Model {
    ...
    public function activate($id, $code = false) {
        ...
        if ($code !== FALSE) {
            ...
            $this->trigger_events('extra_where');
            $this->db->update($this->tables['users'], $data, array('id' => $id, 'id_domain' => $this->ion_auth->get_id_domain()));
        }
    ...
    public function login($identity, $password, $remember = FALSE) {
        ...
        $query = $this->db->select($this->identity_column . ', email, id, password, active, id_domain, last_login')
                ->where($this->identity_column, $identity)
                ->limit(1)
                ->order_by('id', 'desc')
                ->get($this->tables['users']);
    ...
    public function users($groups = NULL) {
        ...
        // filter domain
        $this->db->where(array('id_domain' => $this->ion_auth->get_id_domain()));
    ...
    public function user($id = NULL) {
        ...
        $this->where($this->tables['users'] . '.id_domain', $this->ion_auth->get_id_domain());
