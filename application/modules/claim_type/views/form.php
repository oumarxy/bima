...
<?php }?>     
       ...
       <div class="box-footer">
         ...
         <button type="submit" class="btn btn-info pull-right"><?php echo isset($id_claim_type) ? 'Save' : 'Add';?></button>
      </div><!-- /.box-footer -->
<?php echo form_close();?>
</div>
</div>
...
/* Location: ./application/modules/claim_type/view/create.php */-->
