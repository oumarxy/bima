        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Vat</th>
                        <th>Commission</th>
                        <th>Premium Remmited</th>
                        <th>Premium Remmited+Vat</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($payments as $payment): ?>   
                        ...
                        <tr>
                            ...
                            <td><?php echo number_format($payment->amount - $vat); ?></td>
            ...
            <p>
                <?php if (count($payments) > 0): ?>
                    <?php echo form_open('report/print_remmitance_pdf', 'style="display:inline;"'); ?>
                    ...
                    <?php echo form_open('report/print_remmitance_excel', 'style="display:inline;"'); ?>
                    <input type="hidden" value="<?php echo $from_date; ?>" name="from_date"/>
                    <input type="hidden" value="<?php echo $to_date; ?>" name="to_date"/>
                    <input type="hidden" value="<?php echo $id_insurer; ?>" name="insurer"/>
